...

{
    ...
    else if(nBestHeight > 400000 && nBestHeight <= 550000)
        nSubsidy = nCoinAge * COIN_YEAR_REWARD9 * 33 / (365 * 33 + 8);
    else if(nBestHeight > 550000 && nBestHeight <= 600000)
        nSubsidy = nCoinAge * COIN_YEAR_REWARD10 * 33 / (365 * 33 + 8);
    else if(nBestHeight > 600000 && nBestHeight <= 650000)
        nSubsidy = nCoinAge * COIN_YEAR_REWARD11 * 33 / (365 * 33 + 8);
    else if(nBestHeight > 650000 && nBestHeight <= 700000)
        nSubsidy = nCoinAge * COIN_YEAR_REWARD12 * 33 / (365 * 33 + 8);
    else if(nBestHeight > 700000 && nBestHeight <= 750000)
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // MainNet:
        const char* pszTimestamp = "RatCoin 2.0 crawling out January 28, 2021";
        CTransaction txNew;
        txNew.nTime = 1611830788;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1611830788;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 530773 : 16180;
	...
	fflush(NULL);
        ...
        assert(block.hashMerkleRoot == uint256("0x0b6adaf0ed1c548b5b67c9bd124ffa78c6a05c4e0d681759da5ec23c4d81b32e"));
